...
namespace rst {
    ...
    class rasterizer {
      public:
        ...
        auto load_normals(const std::vector<Eigen::Vector3f>& normals) -> col_buf_id;
        ...
        void set_vertex_shader(std::function<Eigen::Vector3f(VertexShaderPayload)> vert_shader);
        void set_fragment_shader(std::function<Eigen::Vector3f(FragmentShaderPayload)> frag_shader);
        ...
        auto get_depth(int x, int y, int num) -> float;
