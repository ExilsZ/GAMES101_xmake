...
inline auto rayTriangleIntersect(const Vector3f& v0, const Vector3f& v1, const Vector3f& v2,
                                 ...
                                 float& v) -> bool {
    // MARK: Implement this function that tests whether the triangle
...
class MeshTriangle : public Object {
  public:
    ...
    auto intersect(const Vector3f& orig, const Vector3f& dir, float& tnear, uint32_t& index,
                   Vector2f& uv) const -> bool override {
    ...
    [[nodiscard]] auto evalDiffuseColor(const Vector2f& st) const -> Vector3f override {
        float scale   = 5;
